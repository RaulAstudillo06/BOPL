if __name__ == '__main__':
    ...
    if sampling_policy_name is 'uEI':
        ...
        # Sampling policy
        acquisition_optimizer = AcquisitionOptimizer(space=space, model=model, utility=utility, expectation_utility=expectation_utility, optimizer='lbfgs', inner_optimizer='lbfgs')
