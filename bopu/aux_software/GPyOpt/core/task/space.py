...
class Design_space(object):
    ...
    def __init__(self, space, constraints=None, store_noncontinuous=False, n_decision_variables=None):
        ...
        ## --
        self.n_decision_variables = n_decision_variables
    ...
    def get_decision_space_bounds(self):
        """
        Returns the number of decision variables variables.
        """
        bounds = []
        for i in range(self.n_decision_variables):
            var = self.space[i]
            bounds.extend([var.domain]*var.dimensionality)
        return bounds
